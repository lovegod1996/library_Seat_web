    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li id="today" style="display: none;"><a href="<%=request.getContextPath()%>/view/choose_Building?day=0" target="_parent" style="color:#19A094 ">预约今天</a></li>
                <li id="tomorrow" style="display: none;"><a href="<%=request.getContextPath()%>/view/choose_Building?day=1" target="_parent" style="color:#19A094 ">预约明天</a></li>
            </ul>
        </div>
